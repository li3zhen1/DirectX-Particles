	...
	m_coreInput(nullptr)
{
	...
	m_main = std::unique_ptr<CGHomework3ParticlesMain>(new CGHomework3ParticlesMain(m_deviceResources));
...
void CGHomework3Particles::DirectXPage::UpdateVelo(Platform::Object^ sender, Windows::UI::Xaml::Controls::Primitives::RangeBaseValueChangedEventArgs^ e)
{
